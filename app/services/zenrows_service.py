"""
ZenRows service for bypassing Cloudflare protection
"""
import requests
import asyncio
...
class ZenRowsService:
    ...
    async def fetch_manga_chapters(self, manga_id: str) -> Optional[Dict[str, Any]]:
        """
        Fetch manga chapters using ZenRows to bypass Cloudflare
        ...
        target_url = f'https://api.comick.fun/comic/{manga_id}/chapters?date-order=2&lang=en'
        ...
        try:
            ...
            if response.status_code == 200:
                try:
                    ...
                    print(f"✅ ZenRows success! Fetched {len(chapters)} chapters for {manga_id}")
                    return data
