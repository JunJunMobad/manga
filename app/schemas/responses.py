...
class MangaSubscriptionResponse(BaseResponse):
    ...
    subscriptions: Optional[List[str]] = Field(
        None, description="User's current subscriptions"
    )
...
class NotificationResponse(BaseResponse):
    ...
    fcm_response: Optional[Dict[str, Any]] = Field(
        None, description="FCM service response"
    )
...
class UserInfoResponse(BaseModel):
    ...
    subscriptions: List[str] = Field(
        default_factory=list, description="User's manga subscriptions"
    )
